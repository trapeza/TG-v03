...
export default function SearchFiltersCompact() {
    ...
    <div className="space-y-2 pb-2">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
        <div className="space-y-1">
          <label className="text-xs font-medium mb-0.5 inline-block">Chain</label>
        ...
        <div className="space-y-1">
          <label className="text-xs font-medium mb-0.5 inline-block">DEX or Launchpad</label>
          <Select defaultValue="all">
            <SelectTrigger>
        ...
        <div className="space-y-1">
          <label className="text-xs font-medium mb-0.5 inline-block">Category</label>
          <Select defaultValue="all">
            <SelectTrigger>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
        <div className="space-y-1">
          <label className="text-xs font-medium mb-0.5 inline-block">Market Cap Range ($)</label>
          <div className="px-1">
            <Slider
              defaultValue={[0, 100]}
              max={100}
        ...
        <div className="space-y-1">
          <label className="text-xs font-medium mb-0.5 inline-block">Holder Distribution</label>
          <div className="px-1">
            <Slider
        ...
        <div className="space-y-1">
          <label className="text-xs font-medium mb-0.5 inline-block">Volatility (30d)</label>
          <Select defaultValue="all">
            <SelectTrigger>
      ...
      <div className="pt-2">
        ...
        {isAdvancedOpen && (
          <div className="pt-2 space-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
              <div className="space-y-1">
                <label className="text-xs font-medium mb-0.5 inline-block"># of Holders</label>
                <div className="px-1">
                  <Slider
              ...
              <div className="space-y-1">
                <label className="text-xs font-medium mb-0.5 inline-block">Trading Volume (24h)</label>
                <div className="px-1">
                  <Slider
                    defaultValue={[0, 10]}
                    max={10}
              ...
              <div className="space-y-1">
                <label className="text-xs font-medium mb-0.5 inline-block">Maximum Drawdown (%)</label>
                <div className="px-1">
                  <Slider
                    defaultValue={[0, 100]}
                    max={100}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
              <div className="space-y-1">
                <label className="text-xs font-medium mb-0.5 inline-block">Liquidity Pool Range ($)</label>
                <div className="px-1">
                  <Slider
                    defaultValue={[0, 10]}
                    max={10}
              ...
              <div className="space-y-1">
                <label className="text-xs font-medium mb-0.5 inline-block">FDV Cap Range ($)</label>
                <div className="px-1">
                  <Slider
                    defaultValue={[0, 1000]}
                    max={1000}
              ...
              <div className="space-y-1">
                <label className="text-xs font-medium mb-0.5 inline-block">Market Cap / FDV Ratio</label>
                <div className="px-1">
                  <Slider
                    defaultValue={[0, 1]}
                    max={1}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
              <div className="space-y-1">
                <label className="text-xs font-medium mb-0.5 inline-block">Median Holding per Investor ($)</label>
                <div className="px-1">
                  <Slider
                    defaultValue={[0, 10000]}
                    max={10000}
              ...
              <div className="space-y-1">
                <label className="text-xs font-medium mb-0.5 inline-block">Distance from ATH (%)</label>
                <div className="px-1">
                  <Slider
                    defaultValue={[0, 100]}
                    max={100}
              ...
              <div className="space-y-1">
                <label className="text-xs font-medium mb-0.5 inline-block"># of X Followers</label>
                <div className="px-1">
                  <Slider
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
              <div className="space-y-1">
                <label className="text-xs font-medium mb-0.5 inline-block">Revenue ($)</label>
                <div className="px-1">
                  <Slider
                    defaultValue={[0, 100]}
                    max={100}
              ...
              <div className="space-y-1">
                <label className="text-xs font-medium mb-0.5 inline-block">TVL ($)</label>
                <div className="px-1">
                  <Slider
                    defaultValue={[0, 1000]}
                    max={1000}
              ...
              <div className="space-y-1">
                <label className="text-xs font-medium mb-0.5 inline-block">Market Cap per Holder Multiple</label>
                <div className="px-1">
                  <Slider
                    defaultValue={[0, 1000]}
                    max={1000}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
              <div className="space-y-1">
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="team-info" className="text-xs font-medium mb-0.5 inline-block">
                    Team Info Available
                  </Label>
                </div>
              </div>
              ...
              <div className="space-y-1">
                <label className="text-xs font-medium mb-0.5 inline-block">Token Type</label>
                <Select defaultValue="all">
                  <SelectTrigger>
              ...
              <div className="space-y-1">
                <label className="text-xs font-medium mb-0.5 inline-block">Audited</label>
                <Select defaultValue="all">
                  <SelectTrigger>
